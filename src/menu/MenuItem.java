...
/*
en esta clase configuramos la matriz de elemento del menú item, al panel de menú, como componente del menú
...
public class MenuItem extends JButton {
  ...
  private RippleEffect rippleEffect;
   ...
   private int shadowSize = 10;
    private int index;// creamos el indice como entero para almacenar el indice del menú y el submenú
    private boolean subMenuAble;// 
 private float animate;
    // este es el  Submenu  la longitud como el tamaño de la matriz del sumenú
    private int subMenuIndex;
    private int length;

    public MenuItem(String name, int index, boolean subMenuAble) {// tenemos 3 elemntos nombre del menú, indice y submenúAbre
		 // llamamos al supercontructor y pasamos el nombre de la variable
        super(name);
        this.index = index;
        this.subMenuAble = subMenuAble;
    ...
    public void initSubMenu(int subMenuIndex, int length) {// inicializamos el submenú, con indice y longitud   
        this.subMenuIndex = subMenuIndex;
        this.length = length;
   ...
   @Override   
	protected void paintComponent(Graphics grphcs) {
        ...
        if (length != 0) {
          ...
          if (subMenuIndex == 0) {// es para el dibujo de lineas en los subIndice
//                //  First Index
